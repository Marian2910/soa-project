...
### **HrPayroll.OtpService** (Port `5002`)
...
| Micro-frontends | Host App + Standalone OTP App (Port 3001) | ✅ Done |
| Containers | Full docker-compose setup with healthchecks | ✅ Done |
| Documentation | Architecture & usage tutorials | ✅ Done |
...
[![diagram-soa-project.png](https://i.postimg.cc/zBY7QJsX/diagram-soa-project.png)](https://postimg.cc/3y924HrP)
